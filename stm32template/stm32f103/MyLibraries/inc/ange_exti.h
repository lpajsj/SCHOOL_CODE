...
#define ange_EXTI_CLK         RCC_APB2Periph_GPIOB  //使用外部中断是也要打开AFIO时钟
#define ange_EXTI_GPIO_Pin    GPIO_Pin_0
#define ange_EXTI_PortSource  GPIO_PortSourceGPIOB //void GPIO_EXTILineConfig(u8 GPIO_PortSource, u8 GPIO_PinSource)  0123456对应abcdefg
