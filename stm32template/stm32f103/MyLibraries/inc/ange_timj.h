...
#if  ange_tim1
#define ange_TIMjx TIM1
#define ange_TIMj_APBxClock RCC_APB2PeriphClockCmd
#define ange_TIMj_CLK       RCC_APB2Periph_TIM1
#define ange_TIMj_IRQ       TIM1_UP_IRQn
#define ange_TIMj_IRQHandler  TIM1_UP_IRQHandler
#endif
#endif
