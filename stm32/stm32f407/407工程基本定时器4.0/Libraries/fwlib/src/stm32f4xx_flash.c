...
/**
  ...
  * @retval None
  */
void FLASH_SetLatency(uint32_t FLASH_Latency)  //等待时间 CPU 时钟周期与 Flash 访问时间之比，默认是5
{
...
/**
  ...
  * @retval None
  */
void FLASH_PrefetchBufferCmd(FunctionalState NewState)  //使能预取指
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void FLASH_InstructionCacheCmd(FunctionalState NewState)  //使能指令缓存
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void FLASH_DataCacheCmd(FunctionalState NewState)  //使能指令缓存
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void FLASH_InstructionCacheReset(void) //重置指令缓存only when the Instruction Cache is disabled. 
{
...
/**
  ...
  * @retval None
  */
void FLASH_DataCacheReset(void)  //数据缓存复位only when the Data Cache is disabled.
{
