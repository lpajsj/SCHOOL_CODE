...
#define ange_USART_TX_AF            GPIO_AF_USART2
#define ange_USART_TX_AF_Pinsource  GPIO_PinSource2

#define ange_USART_RX_GPIO_PORT 		GPIOA        //改串口是要改的
#define ange_USART_RX_GPIO_Pin  		GPIO_Pin_3   //改串口是要改的
#define ange_USART_RX_AF_Pinsource   GPIO_PinSource3
#define ange_USART_RX_AF            GPIO_AF_USART2
#endif
