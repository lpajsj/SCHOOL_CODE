...
#define ange_TIMt_OC_CLK       RCC_APB1Periph_TIM2
#define ange_TIMt_OC_IRQn       TIM2_IRQn
#define ange_TIMt_OC_IRQHandler  TIM2_IRQHandler
#define ange_TIMt_OC_Prescaler   7200-1
#define ange_TIMt_OC_Period      0xffff
//////
...
//////
///tim2 ch1
#define ange_TIMt_OC_CH1_CLK RCC_APB2Periph_GPIOA
#define ange_TIMt_OC_CH1_PORT GPIOA
#define ange_TIMt_OC_CH1_Pin  GPIO_Pin_0

///tim2 ch2
#define ange_TIMt_OC_CH2_CLK RCC_APB2Periph_GPIOA
#define ange_TIMt_OC_CH2_PORT GPIOA
#define ange_TIMt_OC_CH2_Pin  GPIO_Pin_1
///tim2 ch3
#define ange_TIMt_OC_CH3_CLK RCC_APB2Periph_GPIOA
#define ange_TIMt_OC_CH3_PORT GPIOA
#define ange_TIMt_OC_CH3_Pin  GPIO_Pin_2
///tim2 ch4
#define ange_TIMt_OC_CH4_CLK RCC_APB2Periph_GPIOA
#define ange_TIMt_OC_CH4_PORT GPIOA
#define ange_TIMt_OC_CH4_Pin  GPIO_Pin_3
