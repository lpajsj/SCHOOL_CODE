...
{
	RCC_APB2PeriphClockCmd(ADC6_GPIO_RCC,ENABLE);
	RCC_APB2PeriphClockCmd(ADC8_GPIO_RCC,ENABLE);
...
/*----------------------DAC初始化------------------------------------------------*/	
	...
	DAC_InitStruction.DAC_LFSRUnmask_TriangleAmplitude=DAC_LFSRUnmask_Bit0;
	DAC_InitStruction.DAC_OutputBuffer=DAC_OutputBuffer_Disable;
	DAC_InitStruction.DAC_Trigger=DAC_Trigger_T6_TRGO;
	DAC_InitStruction.DAC_WaveGeneration=DAC_WaveGeneration_None;
...
/*----------------------TIM6初始化------------------------------------------------*/	
	...
	TIM6_TimeBaseInitStruction.TIM_Period=1;
