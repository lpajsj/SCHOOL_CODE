...
/*-----------------------------------------------
  ...
  内容：
------------------------------------------------*/
uchar cfr1[5] = {0x00, 0x40, 0x00, 0x00};						  //cfr1控制字
uchar cfr2[5] = {0x01, 0x00, 0x00, 0x00};						  //cfr2控制字
uchar cfr3[5] = {0x05, 0x0F, 0x41, 0x32};						  //cfr3控制字  40M输入  25倍频  VC0=101   ICP=001;
uchar profile11[9] = {0x3f, 0xff, 0x00, 0x00, 0x25, 0x09, 0x7b, 0x42}; //profile1控制字 0x25,0x09,0x7b,0x42
