...
#define ads8361_OUTB_GPIO_Pin     GPIO_Pin_2
#define BDATA    PAin(2)
#define ads8361_CLOCK_GPIO_CLK    RCC_APB2Periph_GPIOA  //ads8361时钟引脚
#define ads8361_CLOCK_GPIO_PORT     GPIOA
#define ads8361_CLOCK_GPIO_Pin  GPIO_Pin_4
#define CLOCK PAout(4)//
...
#define ads8361_RD_GPIO_Pin     GPIO_Pin_4
#define RD    PCout(4)//
#define ads8361_A0_GPIO_CLK       RCC_APB2Periph_GPIOB //A0 控制引脚
#define ads8361_A0_GPIO_PORT     GPIOB
#define ads8361_A0_GPIO_Pin     GPIO_Pin_0
#define A0    PBout(0)//
...
void ads8361_read00a1(void);  //双通道方式 但是只读取a1   250hz可以读256次
	...
	void ads8361_read00a0(void); //带入参数为 A0状态
		void ads8361_read00b0(void); //带入参数为 A0状态
/////
