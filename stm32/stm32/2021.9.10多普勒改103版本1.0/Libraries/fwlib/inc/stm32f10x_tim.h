...
#define TIM_OCMode_Active                  ((uint16_t)0x0010) //将通道 设置为匹配时输出有效电平,OC1REF 信号强制变为高电平
#define TIM_OCMode_Inactive                ((uint16_t)0x0020) //将通道 1设置为匹配时输出无效电平,OC1REF 信号强制变为低电平。
#define TIM_OCMode_Toggle                  ((uint16_t)0x0030) //翻转––TIMx_CNT=TIMx_CCR1 时OC1REF 发生翻转
