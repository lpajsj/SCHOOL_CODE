...
//软件SPI的AD7799宏定义
#define  AD_RCC				RCC_APB2Periph_GPIOC//AD7799的GPIO时钟
#define  AD_RCC_2			RCC_APB2Periph_GPIOE//AD7799的GPIO时钟

#define  AD_CS_PIN     GPIO_Pin_2 //AD7799的片选引脚
#define  AD_CS_GPIO    GPIOC

#define  AD_DI_PIN     GPIO_Pin_5  	//AD7799的输入引脚
#define  AD_DI_GPIO    GPIOE

#define  AD_SCK_PIN    GPIO_Pin_0	//AD7799的时钟引脚
#define  AD_SCK_GPIO   GPIOC

#define  AD_DO_PIN     GPIO_Pin_3 	//AD7799的输出引脚
#define  AD_DO_GPIO    GPIOE

//#define  AD_RCC				 RCC_APB2Periph_GPIOA//AD7799的GPIO时钟
//#define  AD_CS_PIN     GPIO_Pin_8 	//AD7799的片选引脚
//#define  AD_CS_GPIO    GPIOA

//#define  AD_DI_PIN     GPIO_Pin_7  	//AD7799的输入引脚
//#define  AD_DI_GPIO    GPIOA

//#define  AD_SCK_PIN    GPIO_Pin_11	//AD7799的时钟引脚
//#define  AD_SCK_GPIO   GPIOA

//#define  AD_DO_PIN     GPIO_Pin_6 	//AD7799的输出引脚
