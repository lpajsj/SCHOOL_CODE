...
#define ange_ADC_GPIO_CLK        	RCC_APB2Periph_GPIOA
...
#define ange_ADC_GPIO_Pin5       	GPIO_Pin_5
#define ange_ADC_GPIO_Pin6       	GPIO_Pin_6
#define ange_ADC_GPIO_Pin7      	GPIO_Pin_7
#define ange_ADC_GPIO_PORT      GPIOA
//ADC
#define ange_ADCx         		 	ADC1
#define ange_ADC_APBxClock 			RCC_APB2PeriphClockCmd
#define ange_ADC_CLK       			RCC_APB2Periph_ADC1
//通道选取
#define ange_ADC_Channel_0   	ADC_Channel_0
#define ange_ADC_Channel_1   	ADC_Channel_1
#define ange_ADC_Channel_2   	ADC_Channel_2
#define ange_ADC_Channel_3  	ADC_Channel_3
#define ange_ADC_Channel_4   	ADC_Channel_4
#define ange_ADC_Channel_5   	ADC_Channel_5
#define ange_ADC_Channel_6   	ADC_Channel_6
#define ange_ADC_Channel_7   	ADC_Channel_7
