...
#include "stm32f10x.h"
#include "ange_ad.h"
#define ange_DA_OUT1 0
#define ange_DA_OUT2 1
//DA引脚初始化
#if ange_DA_OUT1
...
//#define ange_DA_DMA_Channel  DMA2_Channel3
#define ange_DA_DMA_Channel    DMA2_Channel4
#define ange_DA_DMA_BufferSize ange_ADC12_DMA_BufferSize ////////
#define ange_DA_DMA_Clock      RCC_AHBPeriph_DMA2
#define ange_DA_DMA_IRQn            DMA2_Channel4_5_IRQn
#define ange_DA_DMA_IRQnHandler     DMA2_Channel4_5_IRQHandler
#endif
///////da 对应tim触发
...
extern u16 da_shuju1[1024];
void ange_DA_init(void);
void ange_DA_DMA_Config(u16* y);
void ange_DA_DMA_nvic_init(void);
